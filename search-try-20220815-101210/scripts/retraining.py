...
parser.add_argument('--arch', type=str, default="Genotype(normal=[[('max_pool_3x3', 0), ('dil_conv_3x3', 1)], [('max_pool_3x3', 0), ('skip_connect', 1)], [('max_pool_3x3', 0), ('sep_conv_5x5', 3)], [('skip_connect', 1), ('max_pool_3x3', 0)]], normal_concat=range(2, 6), reduce=[[('sep_conv_3x3', 0), ('dil_conv_3x3', 1)], [('max_pool_3x3', 0), ('sep_conv_3x3', 1)], [('max_pool_3x3', 0), ('sep_conv_5x5', 1)], [('dil_conv_5x5', 4), ('max_pool_3x3', 0)]], reduce_concat=range(2, 6))", help='which architecture to use')
...
if args.gpus == 'all':
    args.gpus = list(range(paddle.device.cuda.device_count()))
else:
